...
class Chat extends Component {
    ...
    componentDidMount(){
        ...
        this.setState({
            ...
            this.chatholder.scrollTop = 10000
        })
        })
  ...
  render() {
    const messageList = this.state.messagesList.map((e,i) => {
        return(
          <div key={i} className={`${e.name === this.props.name ? "message-right" : "messageholder" }`}>
    ...
    return(
        <div className="papa" ref={messages => {this.chatholder = messages}}>
