                ...
                <div className="checkout_main_body">
                    <div className="checkout_body_form">
                        ...
                        <div className="checkout_sec_wrapper">
                            <div>
                                <input value={this.state.inputAddress} onChange={(e) =>this.handleAddressChange(e.target.value)} placeholder="Street Address"/>
                            </div>
                            <div>
                                <input value={this.state.inputSecAddress} onChange={(e) =>this.handleSecAddressChange(e.target.value)} placeholder="2nd Address and/or Apartment Number"/>
                            </div>
                        </div>
                        <div className="checkout_third_wrapper">
                            ...
                            <input value={this.state.inputZipCode} onChange={(e) =>this.handleZipCodeChange(e.target.value)} placeholder="Zip Code"/>
                        </div>
                    </div>
